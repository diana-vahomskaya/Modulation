...
namespace Modulation
{
    public partial class Form1 : Form
    {
        ...
        private void Choose_Signal()
        {
            ...
            signal = modulation.CreateSignal(AM_Mod.Checked, PM2_Mod.Checked, FM_Mod.Checked);
            var noise = new Noise();
        ...
        public void smth()
        {
            ...
            for (int i = (int)Noise_Min; i <= (int)Noise_Max; i += (int)step)
            {
                ...
                if (i == (int)Noise_Min)
                {
                    SUIS_CHART.ChartAreas[0].AxisY.Minimum = Sustainbility_ALg(TimeDelayRepeats_AM, time_delay, time_delay_by_time_bytes);
                }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            var count = (int)((SampleRate * 1000) / BitSpeed);
            var time_delay_by_time_bytes = delay_suis * 0.5 * modulation.GetTimeMs(count);
